...
import static com.raantech.solalat.user.ui.base.views.appseekbar.SeekBar.INDICATOR_ALWAYS_HIDE;
import static com.raantech.solalat.user.ui.base.views.appseekbar.SeekBar.INDICATOR_ALWAYS_SHOW;
...
public class AppSeekBar extends View {
    ...
    private ArrayList<Price> tickMarkTextArray;
...
//            tickMarkTextArray = t.getTextArray(R.styleable.RangeSeekBar_rsb_tick_mark_text_array);
    ...
    public ArrayList<Price> getTickMarkTextArray() {
        return tickMarkTextArray;
    }

    public void setTickMarkTextArray(ArrayList<Price> tickMarkTextArray) {
